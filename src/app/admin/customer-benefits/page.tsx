      ...
      <div className="max-w-6xl mx-auto p-4 md:p-10 space-y-6 md:space-y-12">
        ...
        <div className="grid grid-cols-3 gap-2 md:gap-8">
          <Card className="bg-white/50 dark:bg-black/50 backdrop-blur-md border-2 border-primary/5 rounded-xl md:rounded-3xl shadow-sm hover:border-primary/20 transition-all duration-300 group">
            <CardContent className="p-3 md:p-8">
              <div className="flex justify-between items-center mb-1 md:mb-3">
                <div className="text-[8px] md:text-xs font-black text-muted-foreground uppercase tracking-widest opacity-50">Clientes</div>
          ...
          <Card className="bg-white/50 dark:bg-black/50 backdrop-blur-md border-2 border-primary/5 rounded-xl md:rounded-3xl shadow-sm hover:border-primary/20 transition-all duration-300 group">
            <CardContent className="p-3 md:p-8">
              <div className="flex justify-between items-center mb-1 md:mb-3">
                <div className="text-[8px] md:text-xs font-black text-muted-foreground uppercase tracking-widest opacity-50">Verified</div>
          ...
          <Card className="bg-white/50 dark:bg-black/50 backdrop-blur-md border-2 border-primary/5 rounded-xl md:rounded-3xl shadow-sm hover:border-primary/20 transition-all duration-300 group">
            <CardContent className="p-3 md:p-8">
              <div className="flex justify-between items-center mb-1 md:mb-3">
                <div className="text-[8px] md:text-xs font-black text-muted-foreground uppercase tracking-widest opacity-50">Full</div>
        ...
        <div className="space-y-6 md:space-y-10">
          <div className="flex items-center gap-4">
             ...
             <h2 className="text-2xl md:text-4xl font-black text-foreground uppercase tracking-tighter">Clientes</h2>
          </div>
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 md:py-32 border-2 border-dashed border-primary/10 rounded-[2.5rem] md:rounded-[4rem] bg-white/30 dark:bg-black/30 backdrop-blur-sm">
              ...
              <h3 className="text-2xl md:text-4xl font-black text-foreground mb-3 tracking-tight">Nada por acá...</h3>
              <p className="text-muted-foreground text-center font-bold opacity-60 max-w-xs md:max-w-md px-6">
                Empezá registrando tu primer cliente para gestionar sus beneficios de lealtad.
              </p>
            </div>
          ) : (
                    ...
                    <div className="p-6 md:p-10">
                      {editingId === customer.id ? (
                        <div className="flex flex-col items-center justify-center py-10 md:py-20 opacity-40">
                          ...
                          <p className="text-xs md:text-sm font-black uppercase tracking-[0.2em] md:tracking-[0.5em]">Editando...</p>
                        </div>
                      ) : (
                        <CustomerCard
                          customer={customer}
